...
| # | Title | Solution | Time | Space | Difficulty | Tag |
|---| ----- |--| --- | ---- | ---- | ---- |
|1|[Two Sum](https://leetcode.com/problems/two-sum/)| [C++](./CPP%2C%20C%2B%2B%20Solutions/1.%20Two%20Sum_1.cpp) | _O(n<sup>2</sup>)_ | _O(n)_ | 🟢 | Array, Hash Table |
|8|[String to Integer (atoi)](https://leetcode.com/problems/string-to-integer-atoi/)| [C++](./CPP%2C%20C%2B%2B%20Solutions/8.%20String%20to%20Integer%20(atoi).cpp)| _O(n)_ | _O(n)_ | 🟠 | Math, String |
|20|[Valid Parentheses](https://leetcode.com/problems/valid-parentheses/)| [C++](./CPP%2C%20C%2B%2B%20Solutions/20.%20Valid%20Parentheses.cpp)| _O(n)_ | _O(n)_ | 🟢 | String, Stack |
...
|215|[Kth Largest Element in an Array](https://leetcode.com/problems/kth-largest-element-in-an-array/)| [C++](./CPP%2C%20C%2B%2B%20Solutions/215.%20Kth%20Largest%20Element%20in%20an%20Array.cpp)| _O(n*logK)_ | _O(K)_ | 🟠 | Array, DnC, Heap(PQ),  Sorting, Quickselect |
|256|[Paint House](https://leetcode.com/problems/paint-house/)🔒|[C++](./CPP%2C%20C%2B%2B%20Solutions/256.%20Paint%20House.cpp)| _O(n)_ | _O(1)_ | 🟠 | DP |
...
|322|[Coin Change](https://leetcode.com/problems/coin-change/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/322.%20Coin%20Change.cpp)| _O(n*amount)_ | _O(amount)_ | 🟠 | DP |
|334|[Increasing Triplet Subsequence](https://leetcode.com/problems/increasing-triplet-subsequence/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/334.%20Increasing%20Triplet%20Subsequence.cpp)| _O(n)_ | _O(1)_ | 🟠 | Adhoc |
|338|[Counting Bits](https://leetcode.com/problems/counting-bits/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/338.%20Counting%20Bits.cpp)| _O(n)_ | _O(n)_ | 🟢 | DP, Bit Manipulation |
|357|[Count Numbers with Unique Digits](https://leetcode.com/problems/count-numbers-with-unique-digits/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/357.%20Count%20Numbers%20with%20Unique%20Digits.cpp)| _O(n)_ | _O(1)_ | 🟠 | Math, DP, Backtracking |
|392|[Is Subsequence](https://leetcode.com/problems/is-subsequence/)| [C++](./CPP%2C%20C%2B%2B%20Solutions/392.%20Is%20Subsequence.cpp)| _O(n)_ | _O(1)_ | 🟢 | Binary Search, DP, Greedy |
|403|[Frog Jump](https://leetcode.com/problems/frog-jump/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/403.%20Frog%20Jump.cpp)| _O(n<sup>2</sup>)_ | _O(n<sup>2</sup>)_ | 🔴 | Array, DP |
|406|[Queue Reconstruction by Height](https://leetcode.com/problems/queue-reconstruction-by-height/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/406.%20Queue%20Reconstruction%20by%20Height.cpp)| _O(n<sup>2</sup>)_ | _O(n)_ | 🟠 | Greedy |
|456|[132 Pattern](https://leetcode.com/problems/132-pattern/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/456.%20132%20Pattern.cpp)| _O(n)_ | _O(n)_ | 🟠 | Stack |
...
|718|[Maximum Length of Repeated Subarray](https://leetcode.com/problems/maximum-length-of-repeated-subarray/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/718.%20Maximum%20Length%20of%20Repeated%20Subarray.cpp)| _O(nm)_ | _O(m)_ | 🟠 | Array, Binary Search, DP, Sliding Window, Rolling Hash, Hash function |
...
|1047|[Remove All Adjacent Duplicates In String](https://leetcode.com/problems/remove-all-adjacent-duplicates-in-string/) |  [C++](./CPP%2C%20C%2B%2B%20Solutions/1047.%20Remove%20All%20Adjacent%20Duplicates%20In%20String.cpp)| _O(n)_ | _O(n)_ | 🟢 | String, Stack |
...
|1220|[Count Vowels Permutation](https://leetcode.com/problems/count-vowels-permutation/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1220.%20Count%20Vowels%20Permutation.cpp)| _O(n)_ | _O(1)_ | 🔴 | DP |
|1313|[Decompress Run-Length Encoded List](https://leetcode.com/problems/decompress-run-length-encoded-list/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1313.%20Decompress%20Run-Length%20Encoded%20List.cpp)| _O(n<sup>2</sup>)_ | _O(n<sup>2</sup>)_ | 🟢 | Array |
|1325|[Delete Leaves With a Given Value](https://leetcode.com/problems/delete-leaves-with-a-given-value/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1325.%20Delete%20Leaves%20With%20a%20Given%20Value.cpp)| _O(n)_ | _O(1)_ | 🟠 | Hash Table, Binary Tree, DFS, BFS |
|1338|[Reduce Array Size to The Half](https://leetcode.com/problems/reduce-array-size-to-the-half/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1338.%20Reduce%20Array%20Size%20to%20The%20Half.cpp)| _O(nlogn)_ | _O(n)_ | 🟠 | Array, Hash Table, Greedy, Sorting, Heap(PQ) |
|1402|[Reducing Dishes](https://leetcode.com/problems/reducing-dishes/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1402.%20Reducing%20Dishes.cpp)| _O(nlogn)_ | _O(1)_ | 🔴 | DP |
|1431|[Kids With the Greatest Number of Candies](https://leetcode.com/problems/kids-with-the-greatest-number-of-candies/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1431.%20Kids%20With%20the%20Greatest%20Number%20of%20Candies.cpp)| _O(n)_ | _O(n)_ | 🟢 | Array |
|1438|[Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit](https://leetcode.com/problems/longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1438.%20Longest%20Continuous%20Subarray%20With%20Absolute%20Diff%20Less%20Than%20or%20Equal%20to%20Limit.cpp)| _O(n)_ | _O(n)_ | 🟠 | Array, Sliding Window |
|1470|[Shuffle the Array](https://leetcode.com/problems/shuffle-the-array/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1470.%20Shuffle%20the%20Array.cpp)| _O(n)_ | _O(n)_ | 🟢 | Array |
|1480|[Running Sum of 1d Array](https://leetcode.com/problems/running-sum-of-1d-array/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1480.%20Running%20Sum%20of%201d%20Array.cpp)| _O(n)_ | _O(1)_ | 🟢 | Array |
|1528|[Shuffle String](https://leetcode.com/problems/shuffle-string/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1528.%20Shuffle%20String.cpp)| _O(n)_ | _O(n)_ | 🟢 | Array, String |
|1641|[Count Sorted Vowel Strings](https://leetcode.com/problems/count-sorted-vowel-strings/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1641.%20Count%20Sorted%20Vowel%20Strings.cpp)| _O(nk)_ | _O(k)_ | 🟠 | Math, DP, Backtracking |
|1689|[Partitioning Into Minimum Number Of Deci-Binary Numbers](https://leetcode.com/problems/partitioning-into-minimum-number-of-deci-binary-numbers/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1689.%20Partitioning%20Into%20Minimum%20Number%20Of%20Deci-Binary%20Numbers.cpp)| _O(n)_ | _O(1)_ | 🟠 | Greedy |
|1710|[Maximum Units on a Truck](https://leetcode.com/problems/maximum-units-on-a-truck/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1710.%20Maximum%20Units%20on%20a%20Truck.cpp)| _O(nlogn)_ | _O(1)_ | 🟢 | Greedy, Sort |
|1720|[Decode XORed Array](https://leetcode.com/problems/decode-xored-array/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1720.%20Decode%20XORed%20Array.cpp)| _O(n)_ | _O(1)_ | 🟠 | Array, Bit Manipulation |
|1859|[Sorting the Sentence](https://leetcode.com/problems/sorting-the-sentence/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1859.%20Sorting%20the%20Sentence.cpp)| _O(n)_ | _O(n)_ | 🟢 | String, Sorting |
|1860|[Incremental Memory Leak](https://leetcode.com/problems/incremental-memory-leak/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1860.%20Incremental%20Memory%20Leak.cpp)| _O(n)_ | _O(1)_ | 🟠 | Simulation |
|1861|[Rotating the Box](https://leetcode.com/problems/rotating-the-box/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1861.%20Rotating%20the%20Box.cpp)| _O(n<sup>2</sup>)_ | _O(n<sup>2</sup>)_ | 🟠 | Array, Two Pointer, Matrix |
|1869|[Longer Contiguous Segments of Ones than Zeros](https://leetcode.com/problems/longer-contiguous-segments-of-ones-than-zeros/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1869.%20Longer%20Contiguous%20Segments%20of%20Ones%20than%20Zeros.cpp)| _O(n)_ | _O(1)_ | 🟢 | String |
|1870|[Minimum Speed to Arrive on Time](https://leetcode.com/problems/minimum-speed-to-arrive-on-time/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1870.%20Minimum%20Speed%20to%20Arrive%20on%20Time.cpp)| _O(nlog(1e7))_ | _O(1)_ | 🟠 | Array, Binary Search |
|1876|[Substrings of Size Three with Distinct Characters](https://leetcode.com/problems/substrings-of-size-three-with-distinct-characters/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1876.%20Substrings%20of%20Size%20Three%20with%20Distinct%20Characters.cpp)| _O(n)_ | _O(1)_ | 🟢 | Hash Table, String, Sliding Window, Counting |
|1877|[Minimize Maximum Pair Sum in Array](https://leetcode.com/problems/minimize-maximum-pair-sum-in-array/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1877.%20Minimize%20Maximum%20Pair%20Sum%20in%20Array.cpp)| _O(nlogn)_ | _O(1)_ | 🟠 | Array, Two Pointer, Greedy, Sorting |
|1878|[Get Biggest Three Rhombus Sums in a Grid](https://leetcode.com/problems/get-biggest-three-rhombus-sums-in-a-grid/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1878.%20Get%20Biggest%20Three%20Rhombus%20Sums%20in%20a%20Grid.cpp)| _O(n<sup>4</sup>)_ | _O(n)_ | 🟠 | Array, Math, Sorting, Heap(PQ), Matrix, Prefix Sum |
|1880|[Check if Word Equals Summation of Two Words](https://leetcode.com/problems/check-if-word-equals-summation-of-two-words/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1880.%20Check%20if%20Word%20Equals%20Summation%20of%20Two%20Words.cpp)| _O(n)_ | _O(1)_ | 🟢 | String |
|1881|[Maximum Value after Insertion](https://leetcode.com/problems/maximum-value-after-insertion/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1881.%20Maximum%20Value%20after%20Insertion.cpp)| _O(n)_ | _O(1)_ | 🟠 | String, Greedy |
|1886|[Determine Whether Matrix Can Be Obtained By Rotation](https://leetcode.com/problems/determine-whether-matrix-can-be-obtained-by-rotation/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1886.%20Determine%20Whether%20Matrix%20Can%20Be%20Obtained%20By%20Rotation.cpp)| _O(n)_ | _O(1)_ | 🟢 | Array |
|1887|[Reduction Operations to Make the Array Elements Equal](https://leetcode.com/problems/reduction-operations-to-make-the-array-elements-equal/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1887.%20Reduction%20Operations%20to%20Make%20the%20Array%20Elements%20Equal.cpp)| _O(nlogn)_ | _O(n)_ | 🟠 | Greedy, Sort |
|1888|[Minimum Number of Flips to Make the Binary String Alternating](https://leetcode.com/problems/minimum-number-of-flips-to-make-the-binary-string-alternating/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1888.%20Minimum%20Number%20of%20Flips%20to%20Make%20the%20Binary%20String%20Alternating.cpp)| _O(n)_ | _O(1)_ | 🟠 | Array, Greedy |
|1893|[Check if All the Integers in a Range Are Covered](https://leetcode.com/problems/check-if-all-the-integers-in-a-range-are-covered/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1893.%20Check%20if%20All%20the%20Integers%20in%20a%20Range%20Are%20Covered.cpp)| _O(n<sup>2</sup>)_ | _O(n)_ | 🟢 | Greedy |
|1894|[Find the Student that Will Replace the Chalk](https://leetcode.com/problems/find-the-student-that-will-replace-the-chalk/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1894.%20Find%20the%20Student%20that%20Will%20Replace%20the%20Chalk.cpp)| _O(n)_ | _O(1)_ | 🟠 | Array, Greedy |
|1895|[Largest Magic Square](https://leetcode.com/problems/largest-magic-square/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1895.%20Largest%20Magic%20Square.cpp)| _O(m<sup>3</sup>n)_ | _O(mn)_ | 🟠 | Array, DP |
|1897|[Redistribute Characters to Make All Strings Equal](https://leetcode.com/problems/redistribute-characters-to-make-all-strings-equal/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1897.%20Redistribute%20Characters%20to%20Make%20All%20Strings%20Equal.cpp)| _O(n<sup>2</sup>)_ | _O(26)_ | 🟢 | String, Greedy |
...
|1922|[Count Good Numbers](https://leetcode.com/problems/count-good-numbers/) | [C++](./CPP%2C%20C%2B%2B%20Solutions/1922.%20Count%20Good%20Numbers.cpp)| _O(logn)_ | _O(1)_ | 🟠 | Math, Recursion |
